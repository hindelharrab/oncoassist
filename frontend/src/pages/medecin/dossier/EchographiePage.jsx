...
const statusStyles = {
  ...
  MALIN: "bg-rose-50 text-rose-700 border-rose-200",
};
  ...
  const [examens, setExamens] = useState([
    {
      ...
      echostructure: 'Hypoéchogène',
      tailleAxe1: '12',
      tailleAxe2: '8',
      tailleAxe3: '10',
      effetsPosterieurs: 'Renforcement',
      vascularisationDoppler: 'Périphérique',
      calcificationsPresentes: 'Non',
      adenopathieAxillaire: 'Non',
      typeStructure: 'Masse',
      scoreBIRADS: '2',
      recommandation: 'Suivi annuel',
      resulatat: 'Kyste simple typique.',
            ...
            >
              ...
              <div className="p-5 lg:p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                  {/* Colonne 1: Localisation & Imagerie */}
                  <div className="flex flex-col gap-6">
                    <div className="flex-1 rounded-2xl border border-slate-200 dark:border-slate-800 bg-[#fcfcfd] dark:bg-slate-900/30 p-5 shadow-sm">
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          ...
                          <select 
                            className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-bold uppercase outline-none focus:border-pink-400"
                            value={formData.seinExamine}
                            onChange={(e) => setFormData({...formData, seinExamine: e.target.value})}
                          >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1">
                            ...
                            <input 
                              className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400"
                          ...
                          <div className="space-y-1">
                            ...
                            <input 
                              className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400"
                              value={formData.distanceMamelon}
                              onChange={(e) => setFormData({...formData, distanceMamelon: e.target.value})}
                              placeholder="3 cm"
                            />
                          </div>
                        </div>
                    ...
                    <div className="rounded-[1.5rem] border border-slate-200 dark:border-slate-800 bg-[#fcfcfd] dark:bg-slate-900/30 p-6 shadow-sm">
                      ...
                      <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:bg-slate-50 dark:hover:bg-slate-900 transition-all cursor-pointer group">
                        ...
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-tight">Transférer Cliché</p>
                      </div>
                    </div>
                  </div>

                  {/* Colonne 2: Morphologie et Signes */}
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="space-y-1">
                            ...
                            <select className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-bold uppercase outline-none focus:border-pink-400" value={formData.orientation} onChange={(e) => setFormData({...formData, orientation: e.target.value})}>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1">
                            ...
                            <input className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400" value={formData.contours} onChange={(e) => setFormData({...formData, contours: e.target.value})} />
                          </div>
                          <div className="space-y-1">
                            <label className="text-[7px] font-black text-slate-500 uppercase tracking-widest ml-1">Vasc. Doppler</label>
                            <select className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-bold uppercase outline-none focus:border-pink-400" value={formData.vascularisationDoppler} onChange={(e) => setFormData({...formData, vascularisationDoppler: e.target.value})}>
                        ...
                        <div className="space-y-1">
                          <label className="text-[7px] font-black text-slate-500 uppercase tracking-widest ml-1">Taille (mm) (Axe 1x2x3)</label>
                          <div className="flex gap-2">
                             <input className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400" value={formData.tailleAxe1} onChange={(e) => setFormData({...formData, tailleAxe1: e.target.value})} placeholder="X"/>
                             <input className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400" value={formData.tailleAxe2} onChange={(e) => setFormData({...formData, tailleAxe2: e.target.value})} placeholder="Y"/>
                             <input className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[11px] font-semibold outline-none focus:border-pink-400" value={formData.tailleAxe3} onChange={(e) => setFormData({...formData, tailleAxe3: e.target.value})} placeholder="Z"/>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                           <div className="space-y-1">
                              ...
                              <select className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-bold uppercase outline-none focus:border-pink-400" value={formData.calcificationsPresentes} onChange={(e) => setFormData({...formData, calcificationsPresentes: e.target.value})}>
                           ...
                           <div className="space-y-1">
                            ...
                            <select className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-bold uppercase outline-none focus:border-pink-400" value={formData.adenopathieAxillaire} onChange={(e) => setFormData({...formData, adenopathieAxillaire: e.target.value})}>
                                <option value="Non">NON</option>
                                <option value="Oui">OUI</option>
                            </select>
                        </div>
                  ...
                  <div className="flex flex-col gap-5 text-slate-900 dark:text-white">
                    <div className="flex-1 rounded-2xl border border-slate-200 dark:border-slate-800 bg-[#fcfcfd] dark:bg-slate-900/30 p-5 shadow-sm">
                      <h3 className="text-[9px] font-black uppercase tracking-[0.22em] mb-4 flex items-center gap-2">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <select 
                            className="w-full h-10 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 text-[10px] font-black uppercase outline-none focus:border-pink-400"
                            value={formData.scoreBIRADS}
                            onChange={(e) => setFormData({...formData, scoreBIRADS: e.target.value})}
                          >
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea 
                            className="w-full h-32 px-4 py-3 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-[11px] font-medium leading-relaxed outline-none focus:border-pink-400 resize-none shadow-sm"
              ...
              <div className="px-6 lg:px-7 py-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3 bg-white dark:bg-slate-950">
                ...
                <button
                  onClick={handleSave}
                  className="h-10 px-5 rounded-xl bg-pink-500 text-white text-[10px] font-bold uppercase tracking-[0.2em] shadow-md hover:bg-pink-600 transition-all flex items-center gap-2"
                >
                  <Save size={12} />
           ...
           {examens.length === 0 && (
             <div className="py-24 flex flex-col items-center justify-center text-center rounded-[2rem] border border-dashed border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-950">
               ...
               <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">
                 Aucun compte-rendu d'échographie
               </p>
             </div>
           )}
           {examens.map((exam) => (
             ...
             >
               <div className="px-5 py-3 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r from-white to-pink-50/20 dark:from-slate-950 dark:to-pink-950/10 flex items-center justify-between">
                 <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-[9px] font-bold text-pink-600 uppercase tracking-widest">Site: {exam.seinExamine}</span>
                 ...
                 <div className="flex items-center gap-2">
                   <button className="flex items-center gap-2 h-8 px-4 rounded-lg bg-slate-950 text-white text-[9px] font-bold uppercase tracking-widest hover:bg-slate-800 transition-all">
                     <Edit2 size={10} strokeWidth={2.8} />
                     Modifier
                   </button>
                   <button className="w-8 h-8 rounded-lg border border-rose-100 dark:border-rose-900/50 flex items-center justify-center text-rose-500 hover:text-rose-600 transition-all">
                ...
                <div className="p-4 lg:p-6 text-slate-900 dark:text-white">
                   <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-4 items-stretch">
                     {/* Bloc Gauche: Contexte & Image (Span 4) */}
                         ...
                         {exam.fichierImage ? (
                           <div className="group relative bg-black aspect-[4/3] overflow-hidden shrink-0">
                             ...
                             <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent p-5 flex flex-col justify-end">
                                ...
                                <p className="text-[9px] text-white/50 font-bold uppercase tracking-widest">Image de référence #01</p>
                             </div>
                             <button className="absolute top-3 right-3 w-9 h-9 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-white/30 hover:scale-105 active:scale-95 shadow-2xl">
                                <FileSearch size={18} />
                             </button>
                           </div>
                         ) : (
                         ...
                         <div className="p-6 flex-1 flex flex-col justify-between">
                            <div className="space-y-4">
                               <div className="flex items-center justify-between">
                                  ...
                                  <div className="px-2.5 py-0.5 rounded-full bg-pink-500 text-[8px] font-black text-white uppercase tracking-widest shadow-lg shadow-pink-500/20">Sein {exam.seinExamine}</div>
                               </div>
                               <div className="grid grid-cols-2 gap-6">
                                  <div className="space-y-1">
                                     <span className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] block">Quadrant</span>
                                     <p className="text-[12px] font-black text-slate-900 dark:text-white uppercase">{exam.quadrant || 'N/A'}</p>
                                  </div>
                                  <div className="space-y-1">
                                     <span className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] block">Distance</span>
                                     <p className="text-[12px] font-black text-slate-900 dark:text-white uppercase">{exam.distanceMamelon || 'N/A'}</p>
                                  </div>
                               </div>
                            </div>
                     ...
                     {/* Bloc Milieu: Morphologie & Détails (Span 4) */}
                     <div className="xl:col-span-4 flex flex-col gap-5">
                         ...
                         <div className="grid grid-cols-1 gap-5 flex-1">
                            <div className="grid grid-cols-2 gap-5">
                               <div className="space-y-1">
                                  ...
                                  <p className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight">{exam.forme || 'N/A'}</p>
                               </div>
                               <div className="space-y-1 text-right">
                                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Orientation</span>
                                  <p className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight">{exam.orientation || 'N/A'}</p>
                               </div>
                            </div>

                            <div className="space-y-1">
                               <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Contours</span>
                               <p className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight leading-snug">{exam.contours || 'N/A'}</p>
                            </div>

                            <div className="space-y-1">
                               <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Échostructure</span>
                               <p className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight leading-snug">{exam.echostructure || 'N/A'}</p>
                            </div>
                            ...
                            <div className="pt-5 border-t border-slate-200 dark:border-slate-800 grid grid-cols-2 gap-5">
                               <div className="space-y-1">
                                  ...
                                  <p className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight">{exam.vascularisationDoppler || 'N/A'}</p>
                               </div>
                               <div className="space-y-1 text-right">
                                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Calcifications</span>
                                  <p className={`text-[11px] font-black uppercase tracking-tight ${exam.calcificationsPresentes === 'Oui' ? 'text-rose-500' : 'text-emerald-500'}`}>{exam.calcificationsPresentes}</p>
                               </div>
                            </div>
                         </div>

                         <div className="p-4 rounded-2xl border border-pink-100 dark:border-pink-900/30 bg-pink-50/70 dark:bg-pink-950/20 text-slate-900 dark:text-white shadow-xl space-y-2">
                            ...
                            <div className="flex items-baseline gap-1.5">
                               ...
                               <span className="text-[10px] font-bold text-pink-500 ml-1 italic uppercase tabular-nums">mm</span>
                            </div>
                         </div>
                       </div>
                     </div>

                     {/* Bloc Droit: Conclusion & Recommandation (Span 4) */}
                     <div className="xl:col-span-4 flex flex-col gap-5">
                           ...
                           <div className="relative z-10 space-y-6 flex-1 flex flex-col">
                              <div className="flex items-start justify-between">
                                 <div className="space-y-1.5">
                                    ...
                                    <p className="text-base font-black text-slate-900 dark:text-white uppercase leading-none tracking-tight">{exam.typeStructure}</p>
                                 </div>
                              ...
                              <div className="space-y-6 pt-6 border-t border-slate-200 dark:border-white/10 flex-1 flex flex-col">
                                 <div className="space-y-3">
                                    ...
                                    <div className="p-4 rounded-xl bg-pink-50/50 dark:bg-pink-900/10 border border-pink-100/50 dark:border-pink-900/30">
                                       <p className="text-[12px] font-black text-slate-900 dark:text-white uppercase leading-relaxed tracking-tight">{exam.recommandation || 'Aucune recommandation'}</p>
                                    </div>
                                 </div>
                                 ...
                                 <div className="space-y-2.5">
                                    ...
                                    <p className="text-[11px] font-medium leading-relaxed italic text-slate-500 dark:text-slate-400 px-1">"{exam.resulatat || 'Aucun commentaire'}"</p>
                                 </div>
